<div>
        ...
        @slot('form')
            <form class="mt-2">
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <x-jet-input-error for="flag" class="mt-2" />
                    </div>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-12 gap-2">
                    @if ($activity == 'create')
                        <a wire:click='store' wire:loading.attr="disabled" wire:target="store, flag"
                    ...
                    @if ($activity == 'edit')
                        <a wire:click='update' wire:loading.attr="disabled" wire:target="update, flag"
    ...
    <x-table-form>
                    ...
                    <tbody>
                        @foreach ($countries as $country)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6">
                                    <img class="w-10 h-10 rounded" src="{{ Storage::url($country->flag) }}" alt="{{ $country->name }}">
                                </td>
                                <td class="py-4 px-6 text-right">
                                    ...
                                    <a wire:click='modalDelete({{ $country->id }})'
        ...
        @endslot
        @slot('paginate')
            {{ $countries->links('vendor.livewire.custom') }}
        @endslot
    </x-table-form>
